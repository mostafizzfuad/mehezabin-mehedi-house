...
// Utility function to format slug back to readable category name
...
function CategoryContent({ slug }: { slug: string }) {
	...
	return (
		<div className="w-full pb-16 md:pb-24">
			{/* Page Header */}
			<div className="bg-[#f9fdf5] py-14 md:py-20 text-center border-b border-gray-100 mb-10 md:mb-16">
				<h1 className="text-4xl md:text-[50px] font-bold text-black mb-4">{categoryName}</h1>
...
export default function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
	...
	return (
		<Suspense fallback={<div className="h-screen flex items-center justify-center">Loading category...</div>}>
